...
**AI / LLM Engineer** · MSc Computer Science (Data Science & AI) · UTBM, France  
Available for **CDI in Paris** from September 2026
...
**AI / ML**  
`PyTorch` `HuggingFace Transformers` `LangChain` `scikit-learn` `PEFT / LoRA` `WandB`
...
[![Email](https://img.shields.io/badge/Email-htan@direct--optic.fr-red?logo=gmail)](mailto:htan@direct-optic.fr)
